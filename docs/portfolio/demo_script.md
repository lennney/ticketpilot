...
| "The retrieval finds relevant knowledge" | "The retrieval pipeline mechanics work; relevance requires real embeddings" |
| "The draft replies are generated by AI" | "The draft replies use template-based generation with evidence citations" |
| "This is production-ready" | "This is an MVP focused on proving the pipeline architecture" |
| "The system can send replies automatically" | "The system requires human review; no auto-send capability exists" |
| "The embeddings capture semantic meaning" | "The embeddings are fake -- they verify pipeline mechanics only" |
| "The knowledge base contains real data" | "The knowledge base contains 36 synthetic seed documents for demo and testing" |
| "The evaluation shows good retrieval quality" | "There is no evaluation pipeline; 325 unit tests and 74 integration tests verify correctness" |
| "Real LLM generates the replies" | "A deterministic FakeDraftProvider generates template-based replies, no LLM involved" |
